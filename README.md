...
# **Platform Note:** 
This manual installation guide applies to Windows and macOS. macOS users have a secondary option: the [DMG file](../../releases) for easy installation.


# Installation+Run🕸
```shell
git clone https://github.com/velixovalena/KiteAi
cd KiteAi
run.bat
```
